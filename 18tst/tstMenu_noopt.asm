...
; This file generated Sun Feb 18 10:13:08 2007
;--------------------------------------------------------
...
;	.line	533; tstMenu.c	LCDzero();                       // Position cursor
	CALL	_LCDzero
;	.line	534; tstMenu.c	nCharCount = 0;                  // Initialize length
	CLRF	r0x03
_00266_DS_:
...
_PowerDown:
;	.line	485; tstMenu.c	void PowerDown( void )
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1L, FSR2L
...
_PowerUp:
;	.line	473; tstMenu.c	void PowerUp( void )
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1L, FSR2L
...
_SpeedDown:
;	.line	444; tstMenu.c	void SpeedDown( void )
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1L, FSR2L
	BANKSEL	_nSpeed
...
_SpeedUp:
;	.line	432; tstMenu.c	void SpeedUp( void )
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1L, FSR2L
	BANKSEL	_nSpeed
...
_WeightDown:
;	.line	406; tstMenu.c	void WeightDown( void )
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1L, FSR2L
	BANKSEL	_nKeyWeight
...
_WeightUp:
;	.line	395; tstMenu.c	void WeightUp( void )
	MOVFF	FSR2L, POSTDEC1
	MOVFF	FSR1L, FSR2L
	BANKSEL	_nKeyWeight
...
; Statistics:
; code size:	 2514 (0x09d2) bytes ( 1.92%)
;           	 1257 (0x04e9) words
